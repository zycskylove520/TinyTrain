...
class LPRBackbone(nn.Module):
    ...
    def __init__(self, nc, dropout_rate):
        ...
        self.backbone = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=64, kernel_size=3, stride=1, bias=False, padding=1),  # 0
            ...
            nn.ReLU(),  # 6
            nn.MaxPool3d(kernel_size=(1, 3, 3), stride=(2, 1, 2), dilation=(1, 1, 1), padding=(0, 1, 1)),  # P1: w/2
            ...
            nn.ReLU(),
            nn.MaxPool3d(kernel_size=(1, 3, 3), stride=(4, 1, 2), dilation=(1, 1, 1), padding=(0, 1, 1)),  # P2: w/4
            nn.Dropout(dropout_rate),
            nn.Conv2d(in_channels=64, out_channels=256, kernel_size=(1, 3), stride=1, bias=False, padding=1),  # 16
            nn.BatchNorm2d(num_features=256),
            nn.ReLU(),  # 18
            nn.Dropout(dropout_rate),
...
if __name__ == '__main__':
    ...
    pool1 = nn.Conv2d(in_channels=256, out_channels=10, kernel_size=(13, 1), stride=1, bias=False)
